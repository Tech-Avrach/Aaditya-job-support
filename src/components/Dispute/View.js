          ...
          <CardBody>
            <Row>
              ...
              <Col md="3">
                ...
                <p className={styles.subHeader}>{disputeDetails?.status}</p>
              </Col>
              <Col md="3">
              ...
              <Col md="3">
                ...
                {disputeDetails?.updatedAt !== null
                  ? new Date(disputeDetails?.updatedAt).toLocaleDateString(
                      "en-US",
                      {
                        day: "numeric",
                        month: "short",
            ...
            <Row>
              <Col md="3">
                ...
                <p className={styles.subHeader}>{disputeDetails?.reason}</p>
              </Col>
            </Row>
          </CardBody>
